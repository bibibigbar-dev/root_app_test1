  ...
  if (loading) {
    return (
      <View style={styles.container}>
        <Header navigation={navigation} title="개인정보관리" showBack={true} />
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.subHead}>
          ...
          <View style={styles.headContent}>
            <Text style={styles.welcomeText}>
              <Text style={styles.welcomeName}>{memberData?.r_name || user?.name}님</Text>, 부자되세요!
            </Text>
        ...
        >
          <TouchableOpacity style={styles.tabItem}>
            <Text style={styles.tabText}>자산관리</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.tabItem}>
            <Text style={styles.tabText}>투자현황</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.tabItem}>
            <Text style={styles.tabText}>투자후기</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.tabItem}
            onPress={() => navigation.navigate('RepaymentSchedule', { user, member_id })}
          >
            <Text style={styles.tabText}>상환스케줄</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.tabItem, styles.tabItemActive]}>
            <Text style={[styles.tabText, styles.tabTextActive]}>개인정보관리</Text>
          </TouchableOpacity>
        </ScrollView>
